    ...
    void verifyUser(ResultSet resultSet,UserDTO user,Response responseObj){
        try {
            if (resultSet.next()) {
                ...
                responseObj.messagesList.add(new Message("Invalid  check your username and password", MessageType.Error));
            }
        } catch (SQLException ex) {
            Message message = new Message("issue.", MessageType.Exception);
